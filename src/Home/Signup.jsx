...
export default function Signup() {
  return (
    <div className="sign-up-container flex w-full py-[60px] px-[200px] xs:py-[20px] xs:px-5 flex-col items-center justify-center gap-2.5 text-white">
      <div className="inline-flex  xs:flex-col sm:flex-col justify-center items-center gap-[70px] xs:gap-5">
        ...
        <div className="sign-up flex flex-col items-start gap-[14px]">
          <div className="email-info border border-solid border-[#ECECEC] bg-white flex xs:w-full sm:w-full w-[523px] py-2.5 px-5 items-center gap-[13px]">
            <div>
          ...
          <button className="flex justify-center py-[12px] px-[178px] xs:px-[40px] sm:px-[40px] items-center gap-2.5 self-stretch text-center font-open_sans text-[16px] leading-[225%] tracking-[0.96px] uppercase bg-primary">
            Subscribe now
          </button>
        </div>
      </div>
